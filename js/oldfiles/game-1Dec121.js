...
$(document).on("vclick", ".scoresBtn", function( ev ){
	...
	//***END REQUIREMENT********	
		...
		console.log("TTTTTTTTTTafter save score remote call");
		}
...
function saveScoreRemote(username,correctAnswers){
	...
	//make the ajax call
	console.log("RRRRRRRRRRRRRRRRRRRbefore in savescore remote");
	var accountName="dani0004"
	
	
	   scoreString ='account=dani0004&username='+username+'&score='+userscore;
        $.ajax({
...
console.log( "TTTTTTTbefore making remote call" );
	$.ajax({
	...
	console.log( "TTTTTTTTTTTbefore formatting report" );
	formatReport(scoreData);
	console.log( "TTTTTTTTTTTTTTTafter formatting report" );
    console.log( scoreData );
	console.log( "after showing data report" );
}).fail(function(jqXHR, textStatus, errorThrown){
    //failed to get data...
    console.log( "ERR: " + errorThrown );
});
		console.log("QQQQQQQQQQQQQafter getting data");

}

function formatReport(scoreData){
	console.log( "formattign report" );
	console.log(scoreData.scores);
	var i=0;
	for (i=0;i<20;i++){
		console.log(scoreData.scores[i].name);
		console.log(scoreData.scores[i].score);
	}
	return;
	var	html1="",html0="",html3="",min22="";;
