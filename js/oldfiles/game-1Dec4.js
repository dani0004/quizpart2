...
$(document).on("click", ".questionsList li", function( ev ){
	...
	else{$("#"+questionId).addClass("wrong");incorrectAnswers+=1;console.log("added class wrong ");localStorage.setItem("classAdded","0");}//add a red class
...
function buildHelpPage(){
		...
		$("#helpList").remove();
			...
			var minihtml1="<li data-role=\"collapsible\" data-theme=\"b\" id=\"h0\" ><h3>Players </h3></li><li data-role=\"collapsible\" data-theme=\"b\" id=\"h0\" ><h3>Game Rules </h3></li><li data-role=\"collapsible\" data-theme=\"b\" id=\"h0\" ><h3>scoring </h3></li><li data-role=\"collapsible\" data-theme=\"b\" id=\"h0\" ><h3>FAQ </h3></li>";
	...
	$("#help div:first-child").prop("data-theme","b");		
